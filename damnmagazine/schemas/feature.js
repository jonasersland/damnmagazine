...
export default {
  ...
  fields: [
    ...
    },
    {
      group:'media',
      name:'thumbnail',
      title:'Thumbnail image for video highlight',
      description: 'The best way to define a thumbnail for the video highlight is by uploading it here.',
      type:'image',
      // hidden: ({ parent }) => !parent.highlightItem.highlightVideo
    },
    {
        name: 'slideshow',
