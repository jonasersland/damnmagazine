  ...
  return (
    <div className="menu-wrapper">
      <div className="menu-static">
        <div
          className="menu-section-logo theme-color-on-hover"
          onClick={() => navigate("/")}
        >
          <DAMNlogo />
        </div>
        ...
        <div
          className={`menu-slogan ${
            !searchFieldActive ? "slogan-visible" : ""
          }`}
        >
        ...
        <div className="menu-section-right">
          ...
          <div className="menu-section-right-buttons">
            <div
              className="menu-section-right-search-button theme-color"
              onClick={() => {
                searchFieldToggleHandler(!searchFieldActive);
              }}
            >
              {searchFieldActive ? <GrClose /> : <BiSearch />}
            </div>
            <div
              className="menu-section-right-menu-button theme-color"
              onClick={() => {
                accordionToggleHandler(!menuState);
      ...
      <div
        className={`menu-section-expanded ${
          menuState ? "menu-section-expanded-display" : ""
        }`}
      >
        ...
        <div className="menu-section-newsletter-wrapper">
          <div className="menu-section-newsletter">
            <div
              className="menu-section-title theme-color"
          ...
          <div className="menu-section-social-buttons">
            <a
              target="_blank"
              className="a-no-style theme-color"
              href="https://www.instagram.com/damn_magazine/"
            >
              <span>
                <FaInstagramSquare />
              </span>
            ...
            <a
              target="_blank"
              className="a-no-style theme-color"
              href="https://www.facebook.com/damnmagazine.net"
            >
              <span>
                <FaFacebookSquare />
              </span>
            ...
            <a
              target="_blank"
              className="a-no-style theme-color"
              href="https://twitter.com/DAMN_magazine"
            >
              <span>
                <FaTwitterSquare />
              </span>
      ...
      <div
        className={`menu-section-newsletter-expanded ${
          newsletterExpanded ? "menu-section-newsletter-expanded-display" : ""
        }`}
      >
