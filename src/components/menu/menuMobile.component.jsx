...
const MenuMobile = ({menuOpen, setMenuOpen}) =>{
    ...
    // const revealMenuSectionHandler =(el)=>{
    //     if (el == menuSectionReveal){
    //         setMenuSectionReveal(null)
    //     } else{
    //         setMenuSectionReveal(el)
    //     }
    // }
...
<path className="st0" d="M38.83,27.64c-0.38,1.06-0.76,2.11-1.13,3.16c-0.48,1.35-0.96,2.69-1.44,4.04c-0.04,0.1-0.07,0.17-0.2,0.17
    ...
    return(
        <div className={`mobile-menu-wrapper ${menuOpen ? 'menu-wrapper-open' : ''}`}>
            <div className="menu-section-logo" onClick={()=>navigate('/')}>
                <DAMNlogo/>
            </div>
            <div className="menu-toggle" onClick={()=>{accordionToggleHandler(!menuOpen);toggleNewsletterExpanded(false)}}>
                {menuOpen ? <span className="close"><GrClose/></span> : <span className="open"><AiOutlineMenu/></span>}
            </div>

            {/* <AccordionMobile menuOpen={menuOpen} newsletterExpanded={newsletterExpanded} menuSectionReveal={menuSectionReveal}> */}
            <div className={`menu-expanded-topics-section ${menuOpen ? 'menu-expanded-open' : ''} `}>
                <div className={`menu-slogan`}>
                    A Magazine for Opinions<br/>on Contemporary Culture
                </div>
                ...
                <div className="menu-search-wrapper">
                    ...
                    <a className="menu-section-title" href='/about'>ABOUT</a><br/>
                    <a className="menu-section-title" href='/features'>FEATURES</a><br/>
                    <a className="menu-section-title" href='/calendar'>CALENDAR</a><br/>
                    <a className="menu-section-title" href='/research-realities'>RESEARCH<br/>& REALITIES</a><br/>
                    <div className="menu-section-newsletter-wrapper">
                        <div className="menu-section-newsletter">
                            <div className="menu-section-title" onClick={()=>toggleNewsletterExpanded(!newsletterExpanded)}>
                                NEWSLETTER
                            </div>
                            <div className={`newsletter-expanded ${newsletterExpanded ? 'newsletter-expanded-display' : ''}`}>
                    ...
                    {/* <div className="menu-section-subscribe"> */}
